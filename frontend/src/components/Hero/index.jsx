        ...
        <section className="py-8 antialiased dark:bg-gray-900 md:py-16">
            <div className="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
                ...
                <div className="hidden md:col-span-5 md:mt-0 md:flex">
                    <img className="dark:hidden" src="https://files.refurbed.com/ii/iphone-14-pro-max-1662626703.jpg" alt="shopping illustration" />
                    <img className="hidden dark:block" src="https://files.refurbed.com/ii/iphone-14-pro-max-1662626703.jpg" alt="shopping illustration" />
                </div>
            </div>
            <LogoCarousel />
